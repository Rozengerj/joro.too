...
namespace joro.too.DataAccess.Migrations
{
    ...
    [Migration("20250402093915_NewSeedingThing")]
    partial class NewSeedingThing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("joro.too.Entities.Show", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MediaImgSrc = "https://res.cloudinary.com/djubwo5uq/image/upload/v1742844720/lhopqfkq2ehjf7ljzlcz.jpg",
                            Name = "One Piece",
                            RatedCount = 10,
                            RatingsSum = 85L
                        });
